...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->FiltrarMovimentos($tipo, $dt_inicial, $dt_final);
    ...
    $dao = new MovimentoDAO();
    $ret = $dao->ExcluirMovimentos($idMov, $idConta, $valor, $tipo);
}
                ...
                <form method="POST" action="consultar_movimento.php">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tipo" id="tipoMov">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="data_inicial" name="data_inicial" placeholder="Coloque a data do movimento..." value="<?= $dt_inicial ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Data Final </label>
                            <input type="date" class="form-control" id="data_final" name="data_final" placeholder="Coloque a data do movimento..." value="<?= $dt_final ?>" />
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span> Empresas Cadastradas. Caso deseje alterar, clique no botão </spam>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-danger square-btn-adjust" data-toggle="modal" data-target="#modalExcluir<?= $i ?>">Excluir</a>
                                                            <form method="POST" action="consultar_movimento.php">
